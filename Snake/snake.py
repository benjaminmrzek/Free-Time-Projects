...
def gameLoop():
    ...
    mavrica=(round(random.randrange(20,225)),round(random.randrange(20,225)),round(random.randrange(20,225)))
    ...
    while not game_over:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                game_over = True
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT and ne_nazaj != 2:
                    x1_spr = -snake_block
                    y1_spr = 0
                    ne_nazaj = 1
                elif event.key == pygame.K_RIGHT and ne_nazaj != 1:
                    x1_spr = snake_block
                    y1_spr = 0
                    ne_nazaj = 2
                elif event.key == pygame.K_UP and ne_nazaj != 4:
                    x1_spr = 0
                    y1_spr = -snake_block
                    ne_nazaj = 3
                elif event.key == pygame.K_DOWN and ne_nazaj != 3:
                    x1_spr = 0
                    y1_spr = snake_block
                    ne_nazaj = 4
        ...
        pygame.draw.rect(dis,mavrica,[hranax,hranay,snake_block,snake_block])
        snake_Head = []
